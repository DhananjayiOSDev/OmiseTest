...
internal class ZVActivityIndicatorView: UIView {
    ...
    internal var timingFunction: CAMediaTimingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeInEaseOut)
    
    private lazy var _activityIndicatorLayer: CAShapeLayer = {
        let activityIndicatorLayer = CAShapeLayer()
        activityIndicatorLayer.lineCap = CAShapeLayerLineCap.round
    ...
    override internal init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ZVActivityIndicatorView.resetAnimating), name: UIApplication.didBecomeActiveNotification, object: nil)
    }
