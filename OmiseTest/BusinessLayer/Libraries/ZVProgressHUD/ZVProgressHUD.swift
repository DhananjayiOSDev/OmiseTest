...
public class ZVProgressHUD: UIView {
    ...
    public var cornerZRadius: CGFloat = 12.0
    ...
    fileprivate lazy var _overlayView: ZVBackgroundView = {
        ...
        overlayView.backgroundColor = UIColor.init(red: 0, green: 0, blue: 0, alpha: 0.3)
...
extension ZVProgressHUD {
    ...
    fileprivate func _prepare() {
        ...
        case .text(let title):
            ...
            _baseView.layer.cornerRadius = self.cornerZRadius * 0.5
        ...
        case .state(let title, let state):
            ...
            _baseView.layer.cornerRadius = self.cornerZRadius
...
extension ZVProgressHUD {
    ...
    /// baseView圆角 NOTE: 当视图为纯文本时圆角为该值的一般
    public static var cornerZRadius: CGFloat {
        get { return self.shared.cornerZRadius }
        set { self.shared.cornerZRadius = newValue }
    }
